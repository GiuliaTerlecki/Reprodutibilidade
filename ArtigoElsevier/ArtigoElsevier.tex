...
do Rio Grande - FURG]{Silvina Botta%
  %
   ...
   \ead{bob@example.com} 
    \author[Another University]{Luis Gustavo Cardoso%
  %
  \fnref{2}}
   \ead{cat@example.com} 
      \affiliation[Some Institute of Technology]{
    organization={Universidade Federal do Rio Grande -
FURG},addressline={1 main
street},city={Gotham},postcode={123456},state={State},country={Brazil},}
    \affiliation[Universidade Federal do Rio Grande - FURG]{
    organization={Instituto de Oceanografia},addressline={A street
29},city={Rio Grande},postcode={2054 NX},country={Brazil},}
...
8, CEP: 96203-000, Rio Grande -- RS, Brazil.}
  ...
  furcal length on δ13C and δ15N isotopic compositions. Significant
  ...
  species. Seasonal differences for δ15N in hot and cold seasons for
  both species related to the dynamic of the Brazilian and the Malvinas
  (Falkland) currents and the shift on the baseline source of nitrogen.
  Differences in δ13C, with enriched values in the warmer season, were
